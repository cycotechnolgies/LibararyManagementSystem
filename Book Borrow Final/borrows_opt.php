                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 mb-3">
                        <div class="mb-3">
                            ...
                            <input id="book_id" class="form-control" type="text" placeholder="BR001" name="borrow_id" value="<?php echo $update ? htmlspecialchars($borrow_id) : htmlspecialchars($newBorrowId); ?>" readonly/>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 mb-3">
                        <div class="mb-3">
                            <label class="form-label" for="mid"><strong>Member ID</strong></label>
                            <input id="mid" class="form-control" type="text" placeholder="M001" name="member_id" value="<?php echo $update ? htmlspecialchars($member_id) : ''; ?>"/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-12 mb-3">
                        <div class="mb-3">
                            ...
                            <input id="book_id" class="form-control" type="text" placeholder="B001" name="book_id" value="<?php echo $update ? htmlspecialchars($book_id) : ''; ?>"/>
                        </div>
                    </div>
